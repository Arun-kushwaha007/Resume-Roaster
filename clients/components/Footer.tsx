        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-8 border-b border-gray-200 dark:border-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/plans" className="hover:text-indigo-500 transition-colors">Plans</Link></li>
              ...
              <li><Link href="/login" className="hover:text-indigo-500 transition-colors">Login</Link></li>
              <li><Link href="/register" className="hover:text-indigo-500 transition-colors">Register</Link></li>
            </ul>
          </div>
          {/* Resources */}
          {/* Resources */}
